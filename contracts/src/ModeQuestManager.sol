...
// Mode Sepolia : 0xECA34040B4E0B9b41f66dF9153c58f44a4836301
...
import "./ModeProofOfWorkoutToken.sol";

contract ModeQuestManager is ERC721, ERC721Enumerable, ERC721URIStorage, IERC721Receiver, Ownable {
    ModeProofOfWorkoutToken _powToken;
    
    using SafeMath for uint256; 
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Proof of Workout Protocol Mode", "POWP") {
        _powToken = ModeProofOfWorkoutToken(0x359B573359DDaF99856F2F036894A5DaD30d55C4);
    } 
