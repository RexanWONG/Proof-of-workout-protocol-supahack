...
// Zora Goerli : 0xd60e43e76F5dfE40EE9d4ACfF82E8b87415D0e0a
...
import "./ZoraProofOfWorkoutToken.sol";

contract ZoraQuestManager is ERC721, ERC721Enumerable, ERC721URIStorage, IERC721Receiver, Ownable {
    ZoraProofOfWorkoutToken _powToken;
    
    using SafeMath for uint256; 
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Proof of Workout Protocol Zora", "POWP") {
        _powToken = ZoraProofOfWorkoutToken(0x22fBF1D57605E5BecBD9478084293E927347203A);
    } 
