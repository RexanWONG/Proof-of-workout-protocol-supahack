...
const Submit = () => {
    ...
    const STRAVA_OAUTH_LINK = `https://www.strava.com/oauth/authorize?client_id=${STRAVA_CLIENT_ID}&response_type=code&redirect_uri=https://proof-of-workout-protocol-cosensys-optimism.vercel.app/submit/${challengeId}&approval_prompt=force&scope=activity:read`
